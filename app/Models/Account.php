 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Account filter($input = array(), $filter = null)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Account paginateFilter($perPage = null, $columns = array(), $pageName = 'page', $page = null)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Account query()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Account simplePaginateFilter($perPage = null, $columns = array(), $pageName = 'page', $page = null)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Account whereBeginsWith($column, $value, $boolean = 'and')
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Account whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Account whereEndsWith($column, $value, $boolean = 'and')
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Account whereLike($column, $value, $boolean = 'and')
...
class Account extends Model
{
    ...
    protected $fillable = ['account_type', 'account_email', 'access_token', 'refresh_token', 'access_token_expires', 'status', 'extend'];
